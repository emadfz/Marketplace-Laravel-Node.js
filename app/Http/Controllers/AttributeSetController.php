...
class AttributeSetController extends Controller {
    ...
    public function create() {
        ...
        $input['all_categories'] = Category::pluck('text', 'id')->all();                
    ...
    public function store(Request $request) {
        ...
        $cat_res = $this->AttributeSetobj->insertattricategory($data_values,$res_attri_set['id']);
    ...
    public function update(Request $request, $id) {
        ...
        $data_values = $request->only('attribute_set_categoryid');        
        $cat_res = $this->AttributeSetobj->insertattricategory($data_values,$id);
