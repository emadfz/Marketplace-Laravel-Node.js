                ...
                <div class="scroller" style="height: 338px;" data-always-visible="1" data-rail-visible1="0" data-handle-color="#D7DCE2">
                    <div class="general-item-list">
                        <div class="item">
                            <div class="item-head">
                                <div class="item-details">
                                    <img class="item-pic rounded" src="{{asset('assets/admin/pages/media/users/avatar4.jpg')}}">
                        ...
                        <div class="item">
                            <div class="item-head">
                                <div class="item-details">
                                    <img class="item-pic rounded" src="{{asset('assets/admin/pages/media/users/avatar3.jpg')}}">
                        ...
                        <div class="item">
                            <div class="item-head">
                                <div class="item-details">
                                    <img class="item-pic rounded" src="{{asset('assets/admin/pages/media/users/avatar6.jpg')}}">
                                    <a href="" class="item-name primary-link">Nick Larson</a>
                        ...
                        <div class="item">
                            <div class="item-head">
                                <div class="item-details">
                                    <img class="item-pic rounded" src="{{asset('assets/admin/pages/media/users/avatar7.jpg')}}">
                                    <a href="" class="item-name primary-link">Nick Larson</a>
                        ...
                        <div class="item">
                            <div class="item-head">
                                <div class="item-details">
                                    <img class="item-pic rounded" src="{{asset('assets/admin/pages/media/users/avatar9.jpg')}}">
                        ...
                        <div class="item">
                            <div class="item-head">
                                <div class="item-details">
                                    <img class="item-pic rounded" src="{{asset('assets/admin/pages/media/users/avatar8.jpg')}}">
                        ...
                        <div class="item">
                            <div class="item-head">
                                <div class="item-details">
                                    <img class="item-pic rounded" src="{{asset('assets/admin/pages/media/users/avatar2.jpg')}}">
...
<script src="{{ asset('assets/admin/pages/scripts/ecommerce-dashboard.min.js') }}" type="text/javascript"></script>
