...
<div class="form-body">
    <div class="form-group {!! $errors->has('status') ? 'has-error' : '' !!}">
        ...
        <div class="col-md-4">
            {!! Form::text('status', null, ['class'=>'form-control', 'placeholder'=>"Enter title"]) !!}
...
<div class="form-body">
    <div class="form-group {!! $errors->has('total_likes') ? 'has-error' : '' !!}">
        ...
        <div class="col-md-4">
            {!! Form::text('total_likes', null, ['class'=>'form-control', 'placeholder'=>"Enter title"]) !!}
...
<div class="form-body">
    <div class="form-group {!! $errors->has('total_dislikes') ? 'has-error' : '' !!}">
        ...
        <div class="col-md-4">
            {!! Form::text('total_dislikes', null, ['class'=>'form-control', 'placeholder'=>"Enter title"]) !!}
...
<div class="form-body">
    <div class="form-group {!! $errors->has('total_comments') ? 'has-error' : '' !!}">
        ...
        <div class="col-md-4">
            {!! Form::text('total_comments', null, ['class'=>'form-control', 'placeholder'=>"Enter title"]) !!}
            {!! $errors->first('topic_name', '<span class="help-block">:message</span>') !!}
        </div>
    </div>
...
<div class="form-body">
    <div class="form-group {!! $errors->has('total_views') ? 'has-error' : '' !!}">
        ...
        <div class="col-md-4">
            {!! Form::text('total_views', null, ['class'=>'form-control', 'placeholder'=>"Enter title"]) !!}
