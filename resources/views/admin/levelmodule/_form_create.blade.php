...
<div class="form-group">
        <label for="inputEmail12" class="col-md-4 control-label">
            {!! Form::label('attribute_set_id', trans("form.level_rights.level_name"), ['class' => 'col-md-16 control-label']) !!}                                                                   
        </label>
                                            <div class="col-md-4">
    ...
    <div class="form-group col-md-12 color-view bg-purple-plum bg-font-purple-plum bold">
        <div class="mt-checkbox-inline ">
            ...
            <label class="mt-checkbox col-md-1">
                ...
                $flag = 0;
                foreach( $input['modules'] as $values )
                { 
                    ?> 
...
<div class="form-group col-md-12">
        <div class="mt-checkbox-inline">
            <label class=" col-md-5">
            {!! Form::label('attribute_set_id', $values->alias_name, ['class' => 'col-md-6 control-label']) !!} 
            {!! Form::hidden("module_id[$flag]", $values->id, ['class'=>'form-control','style'=> 'float: left;width:60%;margin-top: 5px;']) !!}            

                <span></span>
            </label>
            <label class="mt-checkbox col-md-1">
            {!! Form::checkbox("read_access[$flag]", 1,null, ['style'=> 'float: left;width:60%;margin-top: 5px;', 'id' => 'read_access[]' ]) !!}            
            <span></span>
            </label>
            <label class="mt-checkbox col-md-1">
            {!! Form::checkbox("create_access[$flag]", 1,null, ['style'=> 'float: left;width:60%;margin-top: 5px;', 'id' => 'create_access[]']) !!}            
            {!! $errors->first('create_access', '<span class="help-block">:message</span>') !!}
                <span></span>
            </label>
            <label class="mt-checkbox col-md-1">
            {!! Form::checkbox("update_access[$flag]", 1,null, ['style'=> 'float: left;width:60%;margin-top: 5px;', 'id' => 'update_access[]']) !!}            
            {!! $errors->first('update_access', '<span class="help-block">:message</span>') !!}
            <span></span>
            </label>
            <label class="mt-checkbox col-md-1">
            {!! Form::checkbox("delete_access[$flag]", 1,null, ['style'=> 'float: left;width:60%;margin-top: 5px;', 'id' => 'delete_access[]']) !!}            
